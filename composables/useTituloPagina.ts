...
const MAPA_TITULOS: EntradaTitulo[] = [
  ...
  { test: (p) => p === '/contratos/nuevo', titulo: 'Nuevo contrato', breadcrumb: [{ label: 'Contratos', to: '/contratos' }] },
  { test: (p) => p === '/contratos', titulo: 'Contratos' },
  { test: (p) => p === '/novedades/nueva', titulo: 'Registrar novedad', breadcrumb: [{ label: 'Novedades', to: '/novedades' }] },
  { test: (p) => p === '/novedades', titulo: 'Novedades' },
  { test: (p) => p === '/recaudo', titulo: 'Recaudo' },
  { test: (p) => p !== '/recibos' && p.startsWith('/recibos/'), titulo: 'Recibo', breadcrumb: [{ label: 'Recibos', to: '/recibos' }] },
