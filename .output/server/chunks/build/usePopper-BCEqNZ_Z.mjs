...
function usePopper({ locked = false, overflowPadding = 8, offsetDistance = 8, offsetSkid = 0, gpuAcceleration = true, adaptive = true, scroll = true, resize = true, arrow = false, placement, strategy }, virtualReference) {
	return [
		ref(null),
		ref(null),
		ref(null)
...
//# sourceMappingURL=usePopper-BCEqNZ_Z.mjs.map
