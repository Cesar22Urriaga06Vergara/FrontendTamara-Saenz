...
//#endregion
//#region node_modules/@nuxt/ui/dist/runtime/components/overlays/Slideover.vue
var config = mergeConfig(virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Fapp_config_default.ui.strategy, virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Fapp_config_default.ui.slideover, {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
	...
	_push(ssrRenderComponent(_component_TransitionRoot, mergeProps({
		...
		default: withCtx((_, _push, _parent, _scopeId) => {
			if (_push) _push(ssrRenderComponent(_component_HDialog, mergeProps({ class: [
				_ctx.ui.wrapper,
...
var Slideover_default = /*#__PURE__*/ Object.assign(_plugin_vue_export_helper_default(_sfc_main, [["ssrRender", _sfc_ssrRender]]), { __name: "USlideover" });

export { Slideover_default as default };
//# sourceMappingURL=Slideover-DMhjCkqm.mjs.map
