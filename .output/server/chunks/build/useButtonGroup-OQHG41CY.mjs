...
//#region node_modules/@nuxt/ui/dist/runtime/composables/useButtonGroup.js
function useProvideButtonGroup(buttonGroupProps) {
	const groupKey = `group-${getCurrentInstance().uid}`;
	const state = ref({
		children: [],
		register(child) {
...
//# sourceMappingURL=useButtonGroup-OQHG41CY.mjs.map
